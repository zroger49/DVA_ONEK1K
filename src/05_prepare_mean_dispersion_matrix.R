...
# @Description: Prepare the dispersion estimates for modeling
...
out.dir <- paste0(main.dir, "05_lognorm/")
...
mxd <- read.csv(paste0(main.dir, "04_individual_dispersions/", ct_name, "_within_ind_dispersion.txt"), header = T, sep = " ")
...
pdf(paste0(img_dir, ct_name, "_random_genes_distribution.pdf"), h = 8,  w = 8)
...
# Save data
write.table(mxd, paste0(out.dir, ct_name, "_log_nrm_dispersion.tsv"), row.names = F, col.names = T, quote = F, sep = "\t")
