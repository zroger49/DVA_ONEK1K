...
data.dir <- paste0(main.dir, "16_lognorm/")
out.dir <- paste0(main.dir, "17_model_fit/")
...
run_models <- function(iter){
  ...
  ## Read metadata 
  metadata <- readRDS("/gpfs/projects/bsc83/Projects/scRNAseq/rogerioer/immune_system_variability/data/donor_metadata.rds") %>%
...
results <- lapply(1:10, run_models)
