...
theta1 <- list()
for (rep in 1:100){
  temp_data <- read.csv(paste0("results/azimuth_annotation_results/10_theta_simulation_stratified/theta_est_inflation_results_theta1_rep", rep, ".txt"), sep = " ")
...
theta05 <- list()
for (rep in 1:100){
  temp_data <- read.csv(paste0("results/azimuth_annotation_results/10_theta_simulation_stratified/theta_est_inflation_results_theta2_rep", rep, ".txt"), sep = " ")
...
theta01 <- list()
for (rep in 1:100){
  temp_data <- read.csv(paste0("results/azimuth_annotation_results/10_theta_simulation_stratified/theta_est_inflation_results_theta10_rep", rep, ".txt"), sep = " ")
